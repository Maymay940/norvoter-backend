...
urlpatterns = [
    ...
    path('api/add-reading/', views.add_reading, name='api_add_reading'), # добавить показания в БД
    ...
    path("api/requests/<int:request_id>/submit-request/", views.api_submit_request, name="api_submit_request"),  # put сформировать создателем (дата формирования)
